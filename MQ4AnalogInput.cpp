...
MQ4AnalogInput::MQ4AnalogInput(int Pin, String configFile) {
...
bool MQ4AnalogInput::begin() {
	values.resize(1);
	// Set description
	Description.type = "analog input";
	Description.name = "Methane Analog Input";
	Description.id = 0;
	Description.parameterQuantity = 1;
	Description.parameters = {"Methane Analog Signal"};
...
String MQ4AnalogInput::getConfig() {
...
/// @return True on success
bool MQ4AnalogInput::setConfig(String config, bool save) {
	// Allocate the JSON document
  	JsonDocument doc;
...
/// @return True on success
bool MQ4AnalogInput::takeMeasurement() {
...
/// @return True on success
bool MQ4AnalogInput::configureInput() {
...
int MQ4AnalogInput::getAnalogValue(bool average) {
	if (!average) {
...
int MQ4AnalogInput::analogToMV(int value) {
